...
namespace GPSTracking.Domain.Repository
{
    public class Catalog : ICatalog
    {
       ...
       // protected IRepository<Entities.Country> _countryRepo;
        ...
        //protected IRepository<Entities.VehicleOwner> _ownerRepo;
        ...
        public IUnitOfWork UOW
        {
            get 
            {
                if (_uow == null) { _uow = new UnitOfWork1(_context); }
                return _uow;
            }
        }


        //public IRepository<Entities.VehicleOwner> OwnerRepo
        //{
        //    get
        //    {
        //        if (_ownerRepo == null) { _ownerRepo = new GenericRepository<Entities.VehicleOwner>(_context); }
        //        return _ownerRepo;
        //    }
        //}
